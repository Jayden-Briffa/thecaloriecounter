...
--
-- Host: 127.0.0.1    Database: calorie_counter_data
-- ------------------------------------------------------
...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `ingredients_recipeId` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`) ON DELETE CASCADE
...
CREATE TABLE `recipes` (
  ...
  CONSTRAINT `recipes_userId` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-03-21 12:11:13
