  ...
  return (
    <div className='mt-4'>
      <form className='d-flex justify-content-center gap-4' onSubmit={props.handleSubmit}>
          <div className='align-self-center text-center mb-0'>Show the last <AppInput type="number" min="0" max="999" className='d-inline-block rounded rounded-2' id="daysInput" value={props.selectedDays} setValue={props.setSelectedDays} /> days</div>
